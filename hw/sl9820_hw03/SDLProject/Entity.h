enum EntityType { PLATFORM, PLAYER, MESSAGE, FIRE};
...
public:
    ...
    void const check_collision_x(Entity *collidable_entities, int collidable_entity_count,
                                 bool& g_player_win, bool& g_player_lost);
    void add_acceleration(const glm::vec3& additional_acceleration);
    ...
    void move_left()  { m_acceleration.x = -0.25f; };
    void move_right() { m_acceleration.x = 0.25f;  };
